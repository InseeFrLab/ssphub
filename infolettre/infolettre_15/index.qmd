...
évoque des montants de l'ordre de plusieurs millions de dollars.
...
- __Fournir du contexte à un modèle avant de l'interroger__ (_retrieval augmented generation_). __TO BE COMPLETED__
...
- [Hackahton de l'ONU](https://unstats.un.org/bigdata/events/2023/un-datathon/): fermeture des inscriptions à la fin du mois ;
