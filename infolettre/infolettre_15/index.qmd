...
__*Vous désirez intégrer la liste de diffusion ? L'inscription se fait [ici]({{< var signup.form >}}).*__
...
Les personnes intéressées par former une équipe pour les _hackathons_ peuvent contacter {{< var contact.email >}}. 
...
En cas de problème pour le rejoindre, n’hésitez pas à envoyer un mail à {{< var contact.email >}}.
