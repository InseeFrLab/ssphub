...
Le __23 avril de 15h à 16h__, Christophe Dervieux (Posit) nous présentera `Quarto`, l'écosystème de publications reproductibles qui succède à `R Markdown`.

Comme pour l'événement dataviz avec Eric Mauvière (replay dispo 👆️), vous pourrez suivre la retransmission par le biais de Zoom ou venir en salle 4-C-458 si vous êtes à la DG.
