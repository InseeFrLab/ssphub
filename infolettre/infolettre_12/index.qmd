...
![](../../blog/retrospective2022/featured.png){fig-align="center" width=40%}
...
([voir Newsletter #11](../infolettre_11/index.qmd))
...
Déjà annoncée dans la [_Newsletter #11_](../infolettre_11/index.qmd),
...
Plus de détails dans la [_Newsletter #11_](../infolettre_11/index.qmd).

__[Invitation `Outlook` ici](https://minio.lab.sspcloud.fr/ssphub/diffusion/website/2023-03-carpentries/carpentries.ics)__.
...
Pour faire suite à la [_Newsletter #11_](../infolettre_11/index.qmd)
qui présentait l'écosystème autour du package [`Python` `Polars`](https://www.pola.rs/), 
Romain Tailhurat (Insee) nous propose un [post de blog](../../blog/polars/index.qmd) pour découvrir ce _package_. 
