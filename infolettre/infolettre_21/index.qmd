...
# Actualités
Une foule d'articles a été publiée dernièrement sur l'importance de l'open-source, son inter-dépendance avec les solutions payantes, le coût caché de sa maintenance et enfin l'impact sur la souveraineté numérique.
...
- Au delà de la simple inter-dépendance à des logiciels payants, le code open-source est souvent **maintenu bénévolement par des inconnus**, comme les secours en mer ou les pompiers volontaires qui sont assurés en partie par des bénévoles.
