...
Cet événement aura lieu le __13 février de 15h à 16h30__ ([📅 invitation `Outlook`](https://minio.lab.sspcloud.fr/ssphub/diffusion/website/2023-01-Infolettre/Présentation_SSPHub_packages_open_data_Insee.ics)). Si vous êtes utilisateurs de données, que vous veniez de l'Insee ou non, ces packages peuvent vous intéresser !
