...
mis en oeuvre un `chatbot` ouvert, à partir des modèles `LLaMA` (Meta, voir [Newsletter #11](../infolettre_11/index.qmd))
...
par les principales plateformes de _data science_ modernes (notamment par celles s'appuyant sur le logiciel [`Onyxia`](../../blog/onyxia/index.qmd)).
...
Nous rappelons la __journée du réseau le 17 avril, en présentiel__ 📅 ([_Newsletter #12_](../infolettre_12/index.qmd)).
...
du contenu du cours de l'ENSAE ["Bonnes pratiques pour la mise en production de projets _data science_"](https://ensae-reproductibilite.netlify.app/) ayant eu lieu dans le cadre du programme 10% (voir [_Newsletter #12_](../infolettre_12/index.qmd))
...
Le replay est [ici](../../event/ocrisation-teklia/index.qmd) !
...
Le replay est [ici](../../event/presentation-du-projet-meta-academy-carpentries/index.qmd) !
