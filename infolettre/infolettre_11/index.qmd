...
description: |
  Infolettre du mois de __Mars 2023__

# Date published
date: '2023-03-01'
number: 11

image: polars-arrow.png
...
![](https://ssphub.netlify.app/blog/retrospective2022/featured.png){width="40%" fig-align="center"}
...
![](polars-arrow.png){fig-align="center" width=40%}
...
![](hf-js.png){fig-align="center" width=40%}


`Huggingface` et `Observable` sont chacun devenus des incontournables dans leur domaine
(voir notre [_newsletter_ de décembre](https://ssphub.netlify.app/blog/retrospective2022/)).
...
([invitation `Outlook` ](https://minio.lab.sspcloud.fr/ssphub/diffusion/website/2023-03-carpentries/carpentries.ics)).
...
Informations pratiques [ici](https://ssphub.netlify.app/event/presentation-du-projet-meta-academy-carpentries/) !
...
![](https://ssphub.netlify.app/blog/onyxia/featured.png){fig-align="center" width="45%"} 

Le [dernier post](https://ssphub.netlify.app/blog/onyxia/) sur le site
...
réutilisateurs, c'est [par ici](https://ssphub.netlify.app/blog/onyxia/).
...
sur le [site web du réseau](https://ssphub.netlify.app/event/presentation-des-packages-r-et-python-pour-acceder-a-lopen-data-de-linsee/)
