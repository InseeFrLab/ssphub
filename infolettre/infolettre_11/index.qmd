...
![](../../blog/recap2022/featured.png){width="40%" fig-align="center"}
...
(voir notre [_newsletter_ de décembre](../../blog/recap2022/index.qmd)).
...
Informations pratiques [ici](../../event/presentation-du-projet-meta-academy-carpentries/index.qmd) !
...
![](../../blog/onyxia/featured.png){fig-align="center" width="45%"} 

Le [dernier post](../../blog/onyxia/index.qmd) sur le site
...
réutilisateurs, c'est [par ici](../../blog/onyxia/index.qmd).
...
sur le [site web du réseau](../../event/presentation-des-packages-r-et-python-pour-acceder-a-lopen-data-de-linsee/index.qmd)
