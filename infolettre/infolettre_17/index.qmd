---
title: le RAG pour limiter l'hallucination par l'IA ; L'avancée des bases de données vectorielles ; le format Parquet pour simplifier leur usage ; DuckDB débarque en version Web (Infolettre n°17)
description: |
