...
Chaque chapitre de formation, disponible sous la forme de _notebooks jupyter_, peut être ouvert en un clic à partir du [catalogue de formation](https://www.sspcloud.fr/formation?search=&path=%5B%22Initiation%20%C3%A0%20Python%22%5D) du `SSPCloud`.
Ces ressources restent d'ailleurs disponibles en continu pour permettre d'y retourner ultérieurement si besoin. 
...
- tout au long de la formation : vous pouvez poser toutes vos questions sur un canal Tchap dédié ; les mentors de la formation répondent rapidement, afin que vous ne restiez jamais bloqué ;
...
Le [canal Tchap dédié à la formation : `SSPy - Formation "Initiation à Python"`](https://matrix.to/#/#sspy:agent.finances.tchap.gouv.fr) est disponible pour les agents publics ayant un compte `Tchap` afin d'échanger sur cette formation (poser des questions de compréhension, comprendre un _bug_, assister les collègues bloqués, etc.).
