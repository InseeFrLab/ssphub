...
description: |
  Infolettre du mois de __Février 2024__

# Date published
date: '2024-01-20'
number: 17

image: robotroma.jfif
...
![](robotroma.jfif){width=50% fig-align="center"}
...
qui ont été diffusées dans ce format, accompagnées d'un [guide d'utilisation](/blog/parquetRP) mis en ligne sur le blog du SSP Hub (plus de détails dans l'[infolettre #16](/infolettre/infolettre_16)). 
...
- Le [post de blog](/blog/polars/) sur la librairie {{< fa brands python >}} `Polars`, une approche alternative à `DuckDB` ;
...
- Le guide d’utilisation des données du recensement de la population au format Parquet sous forme de [billet de blog](/blog/parquetRP/). 
...
- [Invitation outlook](https://minio.lab.sspcloud.fr/ssphub/diffusion/website/2024-02-09-mauviere/_La dataviz pour donner du sens aux données et communiquer un message_ par Eric Mauvière.ics)
