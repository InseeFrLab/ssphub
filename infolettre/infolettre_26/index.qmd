...
![Aperçu de la liste des formations sur le site du réseau](formations.png){width=300}
...
## IA :
- [Impact de l'IA sur la productivité des développeurs open-source](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/): Étude expérimentale montrant que l'usage d'outils d'IA ralentit de 19% les développeurs expérimentés sur des tâches réelles. Les résultats contrastent fortement avec les perceptions des développeurs et les benchmarks classiques.
Catégories : emploi, IA, performance
...
- [Occupations with the highest divorce rates](https://flowingdata.com/2026/05/07/divorce-and-occupation-2026/): Analyse des taux de divorce selon la profession aux États-Unis. Les chauffeurs de bus affichent les taux les plus élevés tandis que les actuaires présentent les taux les plus bas.
Catégories : data, dataviz, fun
...
Catégories : data, formation, OpenSource, R
...
Catégories : formation, RAG

- [I trained a transformer in an email](https://www.adamoshadjivasiliou.com/blog/transformer-in-email.html): Expérience technique consistant à entraîner et exécuter un modèle transformer directement dans un e-mail via AMP for Email. Utilisation de JavaScript limité et de CSS pour simuler le calcul et le stockage des poids.
Catégories : fun, IA

- [Grand Paris : visualisation interactive des 40 nouveaux districts](https://strategie-plan.eu/datavisualisation-grandparis/#trace): Outil de visualisation interactive pour simuler la refondation administrative du Grand Paris. Permet de composer et nommer 40 districts d'environ 170 000 habitants chacun.
Catégories : cartographie, dataviz, fun, Geo
...
Catégories : OpenSource, performance, R
...
Catégories : data, duckDB, performance, SQL
...
Catégories : duckDB, NLP/texte, Python, SQL
...
Catégories : OpenSource, souveraineté, tools
...
Catégories : performance, Quarto, R
...
Catégories : dataviz, ML, package, Python
...
Catégories : OpenSource, Quarto, R, reproductibilite

## Autre :
- [The Value of Reliable Statistics](https://www.nber.org/papers/w35135): Étude de l'impact de la perte de confiance dans les statistiques publiques sur l'incertitude économique. bénéfice économique lié au maintien de l'intégrité des données officielles estimé à 25$ par $ investi.
Catégories : data, Metier Data, performance

- [Graph database-ball! Exploring the Game with LadybugDB, DuckDB and PostgreSQL](https://theconsensus.dev/p/2026/05/29/ladybug-duckdb-and-postgresql.html): Comparaison des capacités de bases de données orientées graphes entre DuckDB, LadybugDB et PostgreSQL. Analyse de l'expérience utilisateur et des performances via des requêtes sur des données de baseball.
Catégories : data, duckDB, performance

- [Hackathon 2026 de l'Assemblée nationale : le parcours de la loi et l'IA](https://hackathon2026.assemblee-nationale.fr/): Événement les 3 et 4 juillet 2026 visant à explorer l'usage de l'IA dans le processus législatif. Défis centrés sur l'accessibilité de la loi, l'automatisation documentaire et l'aide à la décision.
