...
##  LLM
Dans la série agents, cet [article de Posit](https://posit.co/blog/r-llm-evaluation-03/) compare **différents modèles de LLM pour coder en R** (sans les modèles de Mistral 😮🇫🇷😮).
Résultat : les modèles les mieux évalués à date, mais attention les classements évoluent très vite, sont Claude Sonnet 4.5, Claude Opus 4.5 et OpenAI GPT-5.
