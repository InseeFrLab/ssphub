...
sont disponibles
sur le `Github {{< fa brands github >}} inseefrlab/ssphub` dont le lien est disponible. Pour limiter les duplications de code,
...
le [dernier _post_ de blog](../../blog/parquetRP/index.qmd)
...
départements avec le plus de centenaires ? Le [_post_ de blog](../../blog/parquetRP/index.qmd) vous montrera comment calculer ces statistiques. Et si vous désirez découvrir
