---
title: "La rentrée 2025: actualités, des craintes sur l'IA en termes de bulle ou de sécurité, interview de rentrée"
...
Par ailleurs, le **site du réseau devrait évoluer dans les prochaines semaines**. Il va s'étoffer pour présenter plus de projets en cours et permettre ainsi à tout un chacun de savoir qu'un projet existe et pouvoir échanger entre pairs. Si vous avez des idées ou des envies, n'hésitez pas à les partager ! 

# Actualités
Voici une liste de sujets d'actualité depuis cet été jugés subjectivement intéressants. 

## IA 
Comme toujours, une flopée d'article a été publiée sur l'IA : le nouveau modèle d'OpenAI (GPT-5) a été déployé cet été, des craintes se font entendre sur l'existence d'une bulle financière et, avec l'augmentation de l'utilisation de l'IA, de plus en plus de failles de sécurité liées à l'utilisation de l'IA sont découvertes. Un petit florilège rapide : 

- Sur l'**impact de l'IA sur le travail, la productivité** : 
   - Selon un [article](https://arxiv.org/abs/2507.09089) publié sur arXiv, un essai randomisé avec des développeurs ayant quelques années d'expérience montre que l'usage de l'IA ferait **baisser leur productivité de 19 %**. Les gains de l'IA pour les développeurs seraient ainsi largement surestimés. 
...
- Enfin, la **sécurité de la technologie** commence à poser question : 
