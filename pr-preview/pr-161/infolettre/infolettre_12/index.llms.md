...
![](../../blog/retrospective2022/featured.png)
...
Une [réponse intéressante](https://ponder.io/big-data-is-dead-long-live-big-data/) à l’article *“Big data is dead”* ([voir Newsletter \#11](../../infolettre/infolettre_11/index.llms.md)) revient sur l’intérêt de disposer de données historiques longues pour l’entrainement de modèles d’apprentissage.
...
Déjà annoncée dans la [*Newsletter \#11*](../../infolettre/infolettre_11/index.llms.md), nous rappelons la **journée du réseau le 17 avril, en présentiel** 📅.
...
Pour rappel, Kate Burnett-Isaacs, de Statistics Canada, nous présentera l’initiative Meta Academy / Carpentries le **mardi 28 mars à 15h** 📅. Plus de détails dans la [*Newsletter \#11*](../../infolettre/infolettre_11/index.llms.md).
...
Pour faire suite à la [*Newsletter \#11*](../../infolettre/infolettre_11/index.llms.md) qui présentait l’écosystème autour du package [`Python` `Polars`](https://www.pola.rs/), Romain Tailhurat (Insee) nous propose un [post de blog](../../blog/polars/index.llms.md) pour découvrir ce *package*.
