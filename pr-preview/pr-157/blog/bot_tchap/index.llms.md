...
Ce n’était qu’une première étape pour vérifier que tout marche, **ouvrons Python maintenant**.
...
Une fois ces idées en tête, je suis reparti de la [doc de `simplematrixbotlib`](https://simple-matrix-bot-lib.readthedocs.io/en/latest/examples.html) pour bâtir **un cas tout simple** : un bot qui répond à un mot. Vous lui dites `coucou`, il vous donne l’heure.
