...
> - Le [post de blog](../../post/polars/) sur la librairie `Polars`, une approche alternative à `DuckDB` ;
...
> - Le guide d’utilisation des données du recensement de la population au format Parquet sous forme de [billet de blog](../../post/parquetRP/). Voir aussi l’[*infolettre \#16*](../../infolettre/infolettre_16) ;
