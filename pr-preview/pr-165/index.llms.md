...
![](./infolettre/infolettre_26/prix_stats.png)

##### Le prix de statistiques indépendantes

Infolettre du mois de **juin 2026**
...
Bilan des journées datascience et opensource organisée les 16 et 17 juin 2026
...
![](./blog/bot_tchap/robot_bot_tchap.png)

##### J’ai créé un bot sur Tchap banché à un LLM

Retour d’expérience sur la création d’un bot Tchap branché à un grand modèle de langage : de l’API Matrix jusqu’à la mise en prod sur le SSP Cloud, avec du code prêt à…
...
![](./event/2026-03-dares-conventions-collectives/logo_Dares.png)
...
![](./infolettre/infolettre_23/tva_topography_talk.png)
...
![](./infolettre/infolettre_22/minard.jpeg)
...
![](./infolettre/infolettre_21/newsletter_21.jpg)
...
![](./partenaires/genes/genes_logo.png)
...
![](./partenaires/chair_finance_digital/telecom_logo.png)
...
![](./partenaires/etalab/etalab_logo.png)
...
![](./partenaires/onyxia/onyxia_logo.png)
...
![](./partenaires/spyrales/spyrales_logo.png)

##### Spyrales

Une communauté d'agents de l'Etat pour s'entraider en R et Python

![](./partenaires/uneceML/uneceML_logo.png)
