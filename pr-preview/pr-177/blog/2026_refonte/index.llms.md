...
>
> Python était déjà utilisé pour un post de blog. Il l’est donc à nouveau pour initier des projets et pour que l’environnement soit reproductible grâce à [`uv`](https://docs.astral.sh/uv/). R est utilisé pour ses packages babelquarto et babeldown pour la traduction.
>
