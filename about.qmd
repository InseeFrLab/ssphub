...
title-en: "SSPHub, a network of data scientists"
---
...
- Vous pouvez intégrer notre canal de discussion [`Tchap`]({{< var contact.tchap >}}) ;
- Vous pouvez recevoir l'infolettre en vous inscrivant [ici]({{< var signup.form >}}) ;
...
- Pour toute question, volonté d'échanger, etc, vous pouvez aussi écrire par mail 📧 à {{< var contact.email >}}. 
