...
vous pouvez 
suivre [ce lien vers {{< fa brands github >}}](https://github.com/InseeFrLab/ssphub/edit/main/manifeste/index.md).
:::
...
Ce site relaye à la fois les actions du réseau (posts de blog, présentation de projets menés, événements
...
À court terme, les objectifs du réseau sont de :
...
[^5]: Il est possible de rejoindre ce canal `Tchap` en cliquant [ici]({{< var contact.tchap >}})
