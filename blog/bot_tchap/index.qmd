...
Pour **comprendre la manière dont marche Matrix**, cela a été plus simple quand j'ai compris que **tout est un événement dans Matrix.** Un message, une réaction, une connexion : 
...
en suivant [cette procédure](https://aiml4os.github.io/funathon-project2/2-rag-intro.html#getting-your-llm.lab-api-key). 
