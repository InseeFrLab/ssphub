...
Les deux variables `${SSP_USERNAME}` et `${DOCKERHUB_USERNAME}` ne sont en soit pas des données sensibles. 
Pas besoin d'utiliser des secrets en soit, mais je l'ai fait pour que vous puissiez bien voir où les changer 
dans le contrat yaml ci-dessus. Vous pouvez donc les changer en dur ne pas les avoir en variable d'environnement. 
