...
| **Players** | Insee (DSE), Inpi, Banque de France                                                                                                                                                                                                                                                                                                                                                                     | 
...
| **Project code** | \- 
 <https://github.com/InseeFrLab/ca-document-querier/> Python wrapper for Inpi's enterprise API <br> - 
 <https://github.com/InseeFrLab/extraction-comptes-sociaux> core" repository containing elements for page detection/table extraction <br> - 
 <https://github.com/InseeFrLab/extract-table-ui> code repository for the[experimental interface](https://extract-table-ui.lab.sspcloud.fr/) <br> - 
