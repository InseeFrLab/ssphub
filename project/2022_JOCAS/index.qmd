...
- id: similar-project
  ...
  type: grid
  include:
    categories: ["webscraping", "codification automatique"]
  sort:
  - date desc
  page-size: 6
---
...
| **Acteurs**                  | [DARES](https://dares.travail-emploi.gouv.fr/)     |
