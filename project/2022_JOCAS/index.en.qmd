...
description: The project `Jocas` (Job offers collection and analysis system) project
  enables the DARES (Ministerial Statistical Office for Labour) to automatically
...
- id: similar-project
  ...
  type: grid
  include:
    categories: ["webscraping", "automatic coding"]
  sort: "date desc"
  page-size: 6
---
...
| **Players** | [DARES](https://dares.travail-emploi.gouv.fr/)       |
