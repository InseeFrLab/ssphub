...
description: Utilisation des données de production et de consommation d'électricité pour prévoir l'activité économique
format: html
date: '2020-12-01'
...
| **Acteurs**                  |  Insee     |
| **Résultats du projet**      |  Les données d'électricité ont été utilisées pour prévoir l'activité économique en période de crise.      |
