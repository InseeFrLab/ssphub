...
L'ensemble des projets innovants peut être retrouvé sur la [page dédiée](projects.qmd).
...
Toutes les _newsletters_ précédemment publiées sont disponibles sur la [page dédiée](infolettre.qmd).
